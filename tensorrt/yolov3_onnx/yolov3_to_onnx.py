...
class GraphBuilderONNX(object):
    ...
    def _make_input_tensor(self, layer_name, layer_dict):
        ...
        layer_dict -- a layer parameter dictionary (one element of layer_configs)
        """
        batch_size = layer_dict['batch'] if 'batch' in layer_dict else 1
    ...
    def _make_conv_node(self, layer_name, layer_dict):
        ...
        activation = layer_dict['activation'] if 'activation' in layer_dict else 'linear'
...
def main():
    ...
    if args.output is not None:
        ...
        output_file_path = '%s.onnx' % args.output
